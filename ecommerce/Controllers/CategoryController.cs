...
namespace ecommerce.Controllers
{
    public class CategoryController : Controller
    {
        ...
        private readonly IProductService productService; // إضافة خدمة المنتجات

        public CategoryController(ICategoryService categoryService, IProductService productService, IWebHostEnvironment web) 
        {
            this.categoryService = categoryService;
            this.productService = productService; // تهيئة الخدمة
        ...
        public IActionResult DeleteConfirmed(int id)
        {
            ...
            // حذف المنتجات المرتبطة بهذه الفئة
            var products = productService.GetProductsByCategoryId(id);
            foreach (var product in products)
            {
                productService.Delete(product);
            }
            productService.Save(); // حفظ التغييرات بعد حذف المنتجات
